...
test('28 unique chapters include three isolated new scroll intervals without changing the older allocations',()=>{
 assert.equal(narrative.length,28);assert.equal(new Set(narrative.map(b=>b.id)).size,28);assert.equal(expansionScrollTotal,2600);
 ...
 const args=[57200,1700,440,1400,360,960,20800],base=57200-1700-440-1400-360-960-20800;
