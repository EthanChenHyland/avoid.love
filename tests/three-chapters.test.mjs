...
test('28 unique chapters include three isolated new scroll intervals without changing the older allocations',()=>{
 assert.equal(narrative.length,28);assert.equal(new Set(narrative.map(b=>b.id)).size,28);assert.equal(expansionScrollTotal,1880);
 ...
 const args=[51440,1700,440,1400,360,960,15040],base=51440-1700-440-1400-360-960-15040;
