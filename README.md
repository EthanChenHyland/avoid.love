...
The café and ending videos play in portrait and landscape layouts. Portrait layouts blend into their final artwork after the complete film passage. Coffee steam, rain trails, wind-responsive petals and photograph flips appear within the story. `qa-portrait-source.mjs` checks the embedded-panel-sized viewport and both sides of the mobile breakpoint.
