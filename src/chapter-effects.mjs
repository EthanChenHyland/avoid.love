...
const typeRanges=[...expansionBeats.map(b=>['#'+b.id+'-copy h2',b.range[0],b.range[1]]),['#address-copy h2',.530,.535],['#opening .love',0,.015],['#notice-copy h2',.13,.16],['#little-copy h2',.244,.263],['#unsent-copy h2',.432,.452],['#us-copy h2',.55,.569],['#trying-copy h2',.755,.775],['#impossible-copy h2',.83,.85],['#love-copy h2',.997,1],['#stay-copy h2',.958,.966],['#hours-copy h2',.205,.216],['#detour-copy h2',.614,.625],['#light-copy h2',.917,.93],['#pressed-copy h2',.285,.294],['#blue-copy h2',.390,.402],['#space-copy h2',.720,.731],['#unsaid-copy h2',.514,.524],['#kept-copy h2',.782,.788]];
