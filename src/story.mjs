...
export const narrative=[...chapters,{id:'hours',name:'After hours',at:.218},{id:'detour',name:'The detour',at:.628},{id:'light',name:'Let the light in',at:.934},{id:'pressed',name:'Between the pages',at:.298},{id:'blue',name:'Blue hour',at:.405},{id:'space',name:'The space between',at:.736},{id:'unsaid',name:'All the unsaid things',at:.526},{id:'kept',name:'What stayed',at:.790}].sort((a,b)=>a.at-b.at);
