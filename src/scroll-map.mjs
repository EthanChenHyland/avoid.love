import {expansionBeats,expansionScrollTotal} from './expansion.mjs';
...
export function scrollToStory(y,range,extra,keyExtra=0,stayExtra=0,clockExtra=0,addressExtra=0,expansionExtra=0){
 ...
 const segments=[[...clockScrollRange,clockExtra*.5],[...waitingScrollRange,clockExtra*.5],[...addressScrollRange,addressExtra],[...keptMotionRange,extra],[...keyScrollRange,keyExtra],[...stayScrollRange,stayExtra],...expansionBeats.map(b=>[b.scroll[0],b.scroll[1],expansionExtra*b.scroll[2]/expansionScrollTotal])].sort((a,b)=>a[0]-b[0]);
