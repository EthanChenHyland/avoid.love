...
for(const [width,height] of [[390,844],[639,734],[701,900],[1280,720]]){
 ...
 for(const [film,at] of [['opening',.02],['transition',.12],['transition',.18],['pause',.233],['proof',.317],['home',.605],['waiting',.37],['unsent',.487],['distance',.69],['kept',.77],['kept',.802],['impossible',.92],['impossible',.95],['stay',.976],['stay',1],['impossible',.95],['transition',.18]]){
